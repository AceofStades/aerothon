...
echo "🚀 Launching AEROTHON stack for Intel Laptop..."

# 1. Gazebo Harmonic (NVIDIA variables removed for Intel Mesa compatibility)
kitty --title "AEROTHON: Gazebo" distrobox enter ros -- bash -ic 'export GZ_SIM_SYSTEM_PLUGIN_PATH=$HOME/ardupilot_gazebo/build:${GZ_SIM_SYSTEM_PLUGIN_PATH} && export GZ_SIM_RESOURCE_PATH=$HOME/ardupilot_gazebo/models:${GZ_SIM_RESOURCE_PATH} && gz sim -v4 -r $HOME/ardupilot_gazebo/worlds/iris_runway.sdf; exec bash' &
...
echo "✅ All 4 subsystems have been launched."
